        ...
        <section className="mb-16">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
                {categories.map((category, idx) => (
                    <Link
                        key={idx}
                        className="group flex flex-col items-center justify-center p-6 bg-white dark:bg-surface-dark rounded-xl border border-neutral-100 dark:border-neutral-800 shadow-sm hover:shadow-md hover:border-primary/30 transition-all text-center h-32"
