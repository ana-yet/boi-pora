...
const relatedBooks = [
    { title: "The Alchemist", author: "Paulo Coelho", slug: "the-alchemist", category: "fiction", imageUrl: "https://lh3.googleusercontent.com/aida-public/AB6AXuDkM1RewNMRkU4mJM4bMQyoIhBCWEJm74kHVGuoexFfedbstMzNMOOeQQGcvqSN6VBm2zy2V13FXs7v3lA6IYYvptNG9JUkBwbmrM9zZGW5aiwIP4TFVk2AGLP5XibeVbx_wV3VZ39qvpbH5fgDnlH_ddzs4EIrotgSmqKWdFqeHe6Xl4Cgc_G-6rs9WHgr4GTCBV5g8tWpwOJfqwkuzEANPzxMtpC3n0YV9P7I8IZ3BqHXnX2RBWuo8stbsIohI0pzcVJHrpOGJoXq", imageAlt: "Book cover with orange abstract art" },
    { title: "Life of Pi", author: "Yann Martel", slug: "life-of-pi", category: "fiction", imageUrl: "https://lh3.googleusercontent.com/aida-public/AB6AXuDohSoOtGvQXpVppedZJimCun3VYvIALc9NCNxvL10OeL6GQs0Vk8ZxZLGwoUKvppaYIw49vorFczL_Is2PWWDlDFHZW-dzEVByTZo2YTWVV0OMQCR9aeOw1hYNq13BdzaErNq7RfZrIJ-E3V5tIEwfXxbaZ66sYMK_QFP1eUxHK_yitfJQcxvdl7jMY3CgocnDIAxfUpZVYvLk33EO7dhtRrC_OiTOyLZojEMeB2I2M_LNRc2G27pYhV51y1-XHetdldHlSe2z9NDk", imageAlt: "Book cover featuring silhouette of a person" },
    { title: "Circe", author: "Madeline Miller", slug: "circe", category: "fiction", imageUrl: "https://lh3.googleusercontent.com/aida-public/AB6AXuC3wltAP-E3JrsXbGmQYP6mOLSMCg75b3yLr8Jzb7TtmyGGevCxKWB-jZyPVpnG5X8AGElSkVRc3SzWfB8BpQrdeTu5Mf38EHL2x02DIkzy4qtNma7ic1WcMpHaMPNRO26M52RF3aQZdhlKQrJmhmq6Z8SVrJqMwUlC4QW3yaVpuJvQ36XrP43cPERMadzNDjto1o1gmwaywMMl_PwV49ScT0BjhS49b0i9eI4qsp6byQt4wL30NABycmDELRC7qSjq1r5j6a3JDfHK", imageAlt: "Minimalist blue book cover" },
    { title: "Norwegian Wood", author: "Haruki Murakami", slug: "norwegian-wood", category: "fiction", imageUrl: "https://lh3.googleusercontent.com/aida-public/AB6AXuDvg9cOEoGu9d9kT4sDFpJn6ayZfy57fTn67YA1ly4S_1zqacJus-v3I6MaFEQIKQMhGoVGbss6kCZVPk51VypqZC7C5jJJsm_WMnMssns0rC7-HaXC3eM8EOC3UhE_ooYjeB8QgrKA3CWnoG1X65CNFn6wygZ0zzH8PNYYktOy7y-xcVrIm1m6jawTvZokAK5Sli727UImsYr_2vOB8BhTTVj5MXIzxn1VmviJBT90Y5Fb9COULgQi2gFlZ_Tn3hFyvo4XO3xM0tUH", imageAlt: "Vintage book spine and cover" },
    { title: "Educated", author: "Tara Westover", slug: "educated", category: "nonfiction", imageUrl: "https://lh3.googleusercontent.com/aida-public/AB6AXuAj8tYPrSRoisCOVh-1hFY6EQZjRT3B9s2E6Zs3aeIkxR_8WCeB3_tpNh92J4j2SVxa0FsTW6kGV3-LOiO5HeXaeZq_o9vK-OvU_1_zuRwlg2XmUOlQXSnTOkj2-2RNKv__6-W0CYH7ZIgpLHQ_K00NpIKQw8_xIIv1KsAbbCXY_fWWe7289s2xKRFMliAQJsrj7S57Tx0V0oGifE5YvEI7nEYKYtspyAtLW8IdRGlweeltu_o9EPlKSVVqXLgutrvKLx6yq2E9NG3Q", imageAlt: "White book cover on table" },
    { title: "Where the Crawdads Sing", author: "Delia Owens", slug: "where-the-crawdads-sing", category: "fiction", imageUrl: "https://lh3.googleusercontent.com/aida-public/AB6AXuB5Dpd8QdvP5vmtZFs7EA6o_Tp0XWR8DsX-qns2d1PFuYw2WdOiVPqTYlTHKm2VQKnlgf6Ky1b4-mAAkcLryBH9efp0DiV3iEwtzH7r-iiK__PhfZvtFe1YU1Ftx0-Z2A1v05CHq9oz1mxqV5KfEtKwrjx-CuVdlmcGxciTNCBAq_ruyqSkopT1j5Y7HQEySCOtOmY1unPPV6pCdsx00RlfvCgsg0MGY1PruItxhR5jwsMEO8CUInsgb3m9NRLDxVx05raxvwKdz1Mh", imageAlt: "Stack of colorful books" },
];
        ...
        <main>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-20">
                ...
                <div className="lg:col-span-4 xl:col-span-3 flex flex-col items-center lg:items-start">
                    ...
                    <Link href="/read/the-midnight-library/chapter-1" className="mt-6 w-full lg:hidden flex items-center justify-center gap-2 py-3 bg-white dark:bg-surface-dark border border-neutral-200 dark:border-neutral-700 rounded-lg text-neutral-700 dark:text-neutral-200 font-medium shadow-sm">
                ...
                <div className="lg:col-span-8 xl:col-span-9 flex flex-col justify-start pt-2">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                        <Link href="/read/the-midnight-library/chapter-1" className="flex items-center justify-center gap-3 px-8 py-4 bg-primary hover:bg-primary-dark text-white rounded-lg font-semibold shadow-lg shadow-primary/30 transition-all active:scale-95">
                            <span className="material-icons">play_arrow</span>
                            Start Reading
                        </Link>
                        <Link href="/library" className="flex items-center justify-center gap-3 px-8 py-4 bg-transparent border-2 border-neutral-200 dark:border-neutral-700 hover:border-primary/50 hover:bg-primary/5 text-neutral-700 dark:text-neutral-200 hover:text-primary rounded-lg font-semibold transition-all active:scale-95">
