...
export const metadata: Metadata = {
    title: "My Library",
    description:
        "Your personal digital library — track reading progress, save highlights, and organize your books.",
};
    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
            ...
            <div className="fixed bottom-8 right-8 z-50 lg:hidden">
                <button className="w-14 h-14 bg-primary text-white rounded-full shadow-lg shadow-primary/40 flex items-center justify-center hover:scale-110 active:scale-95 transition-all">
