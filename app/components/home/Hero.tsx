        ...
        <section className="text-center mb-16 max-w-3xl mx-auto">
            ...
            <div className="relative max-w-2xl mx-auto group">
                ...
                <div className="relative flex items-center bg-white dark:bg-surface-dark rounded-full shadow-soft p-2 border border-neutral-200 dark:border-neutral-700">
                    ...
                    <input className="w-full px-4 py-3 bg-transparent border-none focus:outline-none focus:ring-0 text-lg placeholder-neutral-400 text-neutral-800 dark:text-white" placeholder="Search by title, author, or ISBN..." type="text" />
                    <button className="bg-primary hover:bg-primary-dark text-white px-8 py-3 rounded-full font-medium transition-colors shadow-lg shadow-primary/30">
                        Search
                    </button>
                </div>
            </div>
